...
<div class="container main-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3" style="margin-top: 35px;">
            <a ui-sref="site.cart"
               style="padding: 5px 0 0 0; width: 150px">
                <ngcart-summary class="ng-isolate-scope">
                    <div class="row">
                        ...
                        <div popover-placement="bottom" uib-popover-template="popover.url" popover-title="Cart"
                            ...
                            <% } %>
                            <% if (user == null) { %>
                            <div class="col-md-2 col-md-offset-5 text-right" <%=(user == null ? "data-toggle='tooltip' data-placement='bottom' title='Login Please'" : "")%>>
                                <% } %>
